...
## Tasks
 ...
 2. Test and benchmark your implementation using the three examples provided in [data](data/):
    ...
    - [matmul.teir](data/matmul.teir): A blocked matrix multiplication kernel $mk,kn \rightarrow mn$ with $(8192, 819, 8192)$ as $m_0k_0m_1k_1,k_0n_0k_1n_1 \rightarrow m_0n_0m_1n_1$ with $(256,32,128,64,16,512)$.
