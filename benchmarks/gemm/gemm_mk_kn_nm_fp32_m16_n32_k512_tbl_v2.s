...
/*
    ...
    Splits A into 16x16 tiles which are transposed in the SVE vector registers while preserving some of them.
*/
...
_loop02:
    ...
    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z4.s
    fmopa za1.s, p0/m, p0/m, z9.s, z4.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z14.s
    fmopa za1.s, p0/m, p0/m, z9.s, z14.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z10.s
    fmopa za1.s, p0/m, p0/m, z9.s, z10.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z18.s
    fmopa za1.s, p0/m, p0/m, z9.s, z18.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z6.s
    fmopa za1.s, p0/m, p0/m, z9.s, z6.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z16.s
    fmopa za1.s, p0/m, p0/m, z9.s, z16.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z12.s
    fmopa za1.s, p0/m, p0/m, z9.s, z12.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z20.s
    fmopa za1.s, p0/m, p0/m, z9.s, z20.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z5.s
    fmopa za1.s, p0/m, p0/m, z9.s, z5.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z15.s
    fmopa za1.s, p0/m, p0/m, z9.s, z15.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z11.s
    fmopa za1.s, p0/m, p0/m, z9.s, z11.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z19.s
    fmopa za1.s, p0/m, p0/m, z9.s, z19.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z7.s
    fmopa za1.s, p0/m, p0/m, z9.s, z7.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z17.s
    fmopa za1.s, p0/m, p0/m, z9.s, z17.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z13.s
    fmopa za1.s, p0/m, p0/m, z9.s, z13.s
    add x1, x1, x4, LSL #2

    ld1w z8.s, p0/z, [x1]
    ld1w z9.s, p0/z, [x1, #1, MUL VL]
    fmopa za0.s, p0/m, p0/m, z8.s, z21.s
    fmopa za1.s, p0/m, p0/m, z9.s, z21.s
    add x1, x1, x4, LSL #2
